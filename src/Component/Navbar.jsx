...
export const Navbar = () => {
    ...
    return (
        ...
        <>
            <div className="navbar  bg-GlassSurface flex justify-between p-5 items-center sticky top-0 bg-white shadow-md z-50">
            ...
            <div className={active} >
                ...
                <div onClick={() => { setActive("hidden") }} className=" absolute md:hidden z-20 font-medium bg-gray-300  px-20 py-10   rounded-2xl flex flex-col justify-center items-center text-2xl  top-1 right-2 ">
                ...
                <div onClick={toggle}
                    className=" border-2 p-3  rounded-xl  mt-3">
                    {theme == "dark" ?
                        <div className="flex items-center gap-1"><svg
                            ...
                            <p className="text-xl font-normal">Light Mode</p>
                        ...
                        <p className="text-xl font-normal">Dark Mode</p>
                        </div>
                    }
