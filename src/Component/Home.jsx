    ...
    >
            ...
            <div className="flex flex-col items-center my-30 ">
                ...
                <div className="flex flex-col md:flex-row gap-5">
                    ...
                    <Link to="/contact" className="w-60 h-15 text-xl  bg-[linear-gradient(135deg,#3b82f6,#9333ea)] rounded-2xl text-white  my-5 flex justify-center items-center">Get In Touch
            ...
            <div className="flex flex-col items-center mb-[20vh]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 text-center gap-20">
                    <div className="h-80 w-80 bg-PureWhite shadow-xl rounded-2xl flex flex-col justify-center mx-5 ">
            ...
            <div className="flex flex-col justify-center text-center mb-30  ">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-10"> 
                    <Link to="/contact" className="  w-60 h-15 text-xl  bg-[linear-gradient(135deg,#3b82f6,#9333ea)] rounded-2xl text-white flex justify-center items-center">Start a Conversation</Link>
                    <Link to="/resume"  className="  w-60 h-15   text-xl   bg-[linear-gradient(135deg,#3b82f6,#9333ea)] rounded-2xl text-white flex justify-center items-center">Download Resume</Link>
                </div>
            </div>
            </AnimatedGroup>
        </>
