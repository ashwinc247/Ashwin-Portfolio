    ...
    return (
        <>
            <div className="container  flex flex-col items-center mx-auto">
                ...
                <div className="text-xl py-10">Get to know more about my journey as a web developer</div>
            </div>
            <div className="grid md:grid-cols-2 md:p-25 p-13  bg-gray-200 w-[70%] mx-auto rounded-2xl mb-20">
                ...
                <div className="md:ms-20 bg-blue-400  rounded-2xl p-5 text-white h-50 my-5">
